...
//            }
            ...
            FileOutputStream fileOutputStream = new FileOutputStream("D:/ss.txt");

            for (int i = 0; i < 2; i++) {
                String line = in.nextLine();
                /** String can not write into the file direcly */
                /** Transform String into byte array */
                fileOutputStream.write(line.getBytes(), 0, line.getBytes().length);
